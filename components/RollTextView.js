...
import { View, Animated, Easing, Text, TouchableOpacity, InteractionManager, StyleSheet, } from 'react-native';

class RollTextView extends Component {
    constructor(props) {
      super(props);
      this.state = {
          animation : null,
